...
public class SiteHelper {
     ...
     * }
     *
     * @SuppressWarnings("unchecked") public List<RssItem> getRss(){
     ...
     * }
     * @SuppressWarnings("unchecked") public List<SitemapItem> getSitemap(){
     ...
     * }
     * @SuppressWarnings("unchecked") public List<SideBar> getSideBar(){
     ...
     * }
     * @SuppressWarnings("unchecked") public List<Link> getNavBar(){
     ...
     * }
     * @SuppressWarnings("unchecked") public List<Link> getTagCloud(){
     ...
     * }
     * @SuppressWarnings("unchecked") public Map<String, List<Link>> getSitemapLinks() {
     * return (Map)redisHelper.getHashMap("sitemap/links");
     * }
     * @SuppressWarnings("unchecked") public Map<String, List<Card>> getSitemapCards() {
