...
set :linked_files, %w{config/database.yml config/site.yml config/jobber.yml config/keys.yml config/secrets.yml config/attachment.yml config/mailer.yml config/search.yml}
